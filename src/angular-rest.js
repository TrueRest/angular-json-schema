  ...
  angular
    ...
    function ngRestProvider() {
        ...
        function extend (buildedClass, id) {
            if(validateId(id)) return {};
            if(buildedClass.setup) buildedClass.setup(storedAttrs[id].links);
        ...
        function orderArr (object) {
            ...
            for (var i = array.length - 1; i >= 1 ; i--) {
                for (var y = 0; y < i; y++) {
                    if(array[y].propertyOrder && isNaN(array[y].propertyOrder)) array[y].propertyOrder = Infinity;
                    if(array[y + 1].propertyOrder && isNaN(array[y + 1].propertyOrder)) array[y + 1].propertyOrder = Infinity;
